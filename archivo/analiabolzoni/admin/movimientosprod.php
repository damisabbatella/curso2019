  ...
  <content>
    ...
    <div id="comandos">
      ...
      <div id="botonera">
        ...
        <input type="hidden" value="fecha|tipo|idproducto|idpropietario|idtalle|idcolor|cantidad|observaciones" id="columnas"/>
    	<input type="hidden" value="movimientosprod" id="tabla"/>
      </div>
    </div>
    ...
    <div id="titulos">
      ...
      <div class="col3">PRODUCTO</div>
      <div class="col8">TALLE</div>
      <div class="col8">COLOR</div>
      <div class="col3">PROPIETARIO</div>
      <div class="col8">CANTIDAD</div>
      <div class="col8">Observaciones</div>
