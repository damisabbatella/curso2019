  ...
  <h1>Materiales</h1>
    <div id="comandos">
      ...
      <div id="botonera">
        ...
        <input type="hidden" value="nombre|codigo|categoria|unidad|precio" id="columnas"/>
    	<input type="hidden" value="materiales" id="tabla"/>
      </div>
    </div>
    ...
    <div id="titulos">
      ...
      <div class="col3">UNIDAD</div>
      <div class="col3">PRECIO</div>
