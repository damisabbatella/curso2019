...
<section>
  ...
  <content>
    ...
    <div id="comandos">
      ...
      <div id="botonera">
        <input type="button" value="Nueva Venta" onClick="nuevo()"/>
        <input type="hidden" value="fecha|idcliente|estado" id="columnas"/>
    	<input type="hidden" value="ventas" id="tabla"/>
      </div>
    </div>
