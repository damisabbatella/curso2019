  <?php
	...
	$sql = "select a.id,a.fecha,a.tejedor,a.estado,a.status,
	c.id, c.nomestado
	from $tabla a, estados c
	...
	?>
      <div id="f<?php echo $cont?>" class="fila <?php echo $clase ?>">
        ...
        <?php
        if($fila['estado']==1){?>
        <div class="col4"><button onclick="nuevaprendaorden(<?php echo $fila['id']?>)">cargar orden</button></div>
