...
$sql3 = "select a.id iditem ,a.idconsignacion, a.idproducto,a.idtalle,a.idcolor,a.cantidad,
  ...
  ?>
      <div id="f<?php echo $cont3?>" class="fila <?php echo $clase3 ?>">
        ...
        <div class="col120"><?php echo $fila3["producto"] ?></div>
        ...
        <div class="col90">
        <input type="number" id="vendidos<?php echo $fila3["iditem"] ?>" max="<?php echo $fila3["cantidad"] ?>" min="0" class="cantliq" value="<?php echo $fila3["cantidad"] ?>" /> <input type="number" id="devueltos<?php echo $fila3["iditem"] ?>" max="<?php echo $fila3["cantidad"] ?>" min="0" class="cantliq" value="0" onChange="devolucion(<?php echo $fila3["iditem"] ?>)"/>
        </div>
  ...
  <div class="campos">
  <input type="button" id="aceptar" value="CALCULAR" onClick="calcular(<?php echo $_POST['idconsignacion'] ?>)"/>
    <input type="button" id="aceptar" value="LIQUIDAR" onClick="liquidar(<?php echo $_POST['idconsignacion'] ?>)"/>
  </div>
</div>
