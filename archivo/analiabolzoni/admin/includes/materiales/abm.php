  <?php
	...
	$sql = "select a.id idfila, a.codigo, a.categoria, a.nombre, a.precio, a.unidad, a.status, b.id, b.titulo from $tabla a, categorias b where a.status=1 and b.id=a.categoria $buscador limit $inicio,$paso";
	$res = mysql_query($sql);
	$cont = 0;
	...
	?>
      <div id="f<?php echo $cont?>" class="fila <?php echo $clase ?>">
        ...
        <div class="col3"><?php echo $fila["titulo"] ?></div>
