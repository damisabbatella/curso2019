<?php
	/*
	Template Name: Plataforma LOGIN
	*/
...
function escondezocalo(){
	
document.getElementById("zocalocustom").style.bottom="-120px";	
	}		
...
<body id="top" <?php body_class($style." ".$avia_config['font_stack']." ".$blank); avia_markup_helper(array('context' => 'body')); ?> onload="lge(1); cargar();muestrausuario();escondezocalo()">
...
function playradio(radio,alto,gen){
	var radios= new Array("","popmania","rockola","zoom","okay","blondie","deejay","neo","bpm","fx","juno","platinum","moonlight","eighties","nikita","rouge","pinny","sweet","frida","katmandu","rockett","legiao","kingston","graffiti","underground","memphis","nashville","cafeibiza","tatoo","touchandgo","delikatessen","caramel","trendy","female","rainbow","jade","shangrila","fragile","vaudeville","jazzy","scotchandsoda","manhattan","afterhour","pianobar","village","easy","bossanostra","boogie","jumping","ray","swing","foxtrot","gatsby","cottonclub","dixie","avalon","7lunas","feelings","z95","leCoin","club74","help","ebony","motown","always","rockabilly","picnic","oyetu","alo","babylon","jijo","muevete","danzon","inolvidable","cantares","slowly","paradise","melody","lullaby","splendor","zen","celtic","malibu","bongo","opus1","pizzicato","gala","viena","caruso","diva","pianissimo","gotan","pasional","libertango","tanghetto","raices","beijaflor","cidade","ipanema","saiba","pigalle","bistro","cherie","volare","ciao","fadomeu","voyage","travesia","iupi","kinder","babybox","gulubu")
...
/*$("#jquery_jplayer_1").jPlayer("destroy");	
 $("#jquery_jplayer_1").jPlayer({
	...
	*/
	seleccionar_estacion(radios[radio])
	}	
...
<div id="plataforma">
  ...
  <ul class="col4">
    ...
    <li><a href="#" onmouseover="clogo(3723)" onmouseout="clogo(0)" onclick="playradio(50,3723,4)" id="r50">Swing</a></li>
...
<div id="zocaloambient">
<div id="contzocalo">
<div id="logosbarra"></div>
<div id="playerwinzocaloambient">
<script>
      if(-1 != navigator.userAgent.indexOf("MSIE"))
      {
        document.write('<div align="center" style="width:100%"><OBJECT id="WMP"');
        document.write(' classid="clsid:6BF52A52-394A-11d3-B153-00C04F79FAA6"');
        document.write(' width="400" height="78"><PARAM NAME="ShowControls" VALUE="false"><PARAM NAME="uiMode" VALUE="mini"></OBJECT></div>');
      }
      else 
      {
        document.write('<div align="center" style="width:100%"><OBJECT id="WMP"'); 
        document.write(' type="application/x-ms-wmp"'); 
        document.write(' width="400" height="78"><PARAM NAME="ShowControls" VALUE="true"><PARAM NAME="uiMode" VALUE="mini"></OBJECT></div>');
      }         
</script>
