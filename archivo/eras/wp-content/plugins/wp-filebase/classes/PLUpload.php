...
<div id="drag-drop-area">
	...
	<p class="drag-drop-info"><?php _e('Arrastra archivos aquí- o -',WPFB); ?> <span class="drag-drop-buttons"><input id="plupload-browse-button" type="button" value="<?php esc_attr_e('Select Files'); ?>" class="button" /></span></p>
	...
	<?php printf( __( 'Usando gestor multiarchivo. Algún Problema? Pruebe con <a href="%1$s">browser uploader</a> .' ), esc_url(add_query_arg('flash', 0)) ); ?>
