...
<h2>Configuración del upload</h2>
...
<tr class="form-field">
	...
	<th scope="row"><label for="batch_category">Categoría</label></th>
...
<tr class="form-field">
	...
	<th scope="row"><label for="batch_post_id">Adjuntar a la entrada</label></th>
...
<tr>
	...
	<label for="batch_offline" style="display: inline;"><?php _e('No publicar los archivos subidos (ver offline)', WPFB) ?></label></td>
	...
	<div id="batch-drag-drop-uploader">
		...
		<div id="batch-drag-drop-area">
			...
			<div style="margin: 70px auto 0;">
				...
				<p class="drag-drop-info"><?php _e('Arrastre y suelte archivos aquí'); ?></p>

				<p><?php _ex('o', 'Uploader: Drops files here - or - Select Files'); ?></p>

				<p class="drag-drop-buttons"><input id="batch-browse-button" type="button" value="<?php esc_attr_e('Selecccione Archivo'); ?>" class="button" /></p> 			
