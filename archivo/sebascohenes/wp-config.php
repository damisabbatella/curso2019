...
define( 'WP_HOME', 'http://seca.com.ar/fgfgsebascohenes/' );
define( 'WP_SITEURL', 'http://seca.com.ar/fggsebascohenes/' );

define('DB_NAME', 'fgfgfggeografia');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'fgggfgfggeografia');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'Sebas2014!');

/** Host de MySQL (es muy probable que no necesites cambiarlo) */
define('DB_HOST', '72.167.233.113');
