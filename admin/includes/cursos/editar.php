...
<form id="miFormulario"  method="POST" enctype="multipart/form-data" action="editarcurso.php?id=<?=$fila["id"]?>"  >
    <div id="formulario">
...
<?
    $imagen=($fila["imagen"]!="")?$fila["imagen"]:"sinimagen.jpg";
    ?>
            <img id="imageneditar" class="img-thumbnail col-lg-1"  src="../../../img/portfolio/<?=$imagen?>">
            <input name="foto_portada" class="form-control" id="campo3"   type="file" onchange="document.getElementById('imageneditar').style.display='none'" />
           </div>
