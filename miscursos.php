...
<li>comprar creditos</li> 
    ...
    <section id="cursos" class="bg-light-gray">
        <div class="container">
            ...
            <ul class="list-group">
                        <?
$sql2="SELECT * from cursos where status=1";
$resultado2=mysqli_query($con,$sql2);
while($fila=mysqli_fetch_assoc($resultado2)){
  $sql3="SELECT COUNT(*) AS inscriptos from rel_cursos_alumnos where idcurso=".$fila["id"];
$resultado3=mysqli_query($con,$sql3);
$inscriptos=mysqli_fetch_assoc($resultado3);

                    ?>

                    <li class="list-group-item" onclick="mostracurso(<?=$fila["id"]?>)"><span class="badge"><?=$inscriptos["inscriptos"]?></span> <button class="btn btn-info btn-lg"><?=$fila["curso"] ?></button></li>
...
<div class="col-lg-12">
   ...
   <?
$sql1="SELECT b.id idcursos,b.curso,b.descripcion,b.texto,b.orden,b.imagen,b.status,a.id,a.idcurso,a.idalumno from cursos b,rel_cursos_alumnos a where a.idcurso=b.id
 and  a.idalumno=".$_SESSION["idusuario"];
$resultado=mysqli_query($con,$sql1);
while($curso=mysqli_fetch_assoc($resultado)){
?>

<div class="col-lg-3"><h4><?=$curso["curso"]?></h4>

<a href='vercurso.php?tipo=<?=$curso["idcursos"]?>'><img class="img-thumbnail" src="/img/portfolio/<?=$curso["imagen"]?>"/></a>
<div class="progress">
