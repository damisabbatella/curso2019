        ...
        <div class="container">
            ...
            <ul class="list-group">
                    ...
                    <div class="col-lg-12 text-center">
                       <?
$sql1="SELECT * from cursos where id=".$_GET["tipo"];
$resultado1=mysqli_query($con,$sql1);
$programa=mysqli_fetch_assoc($resultado1);



                       ?>

                       <div class="col-lg-6"><h4><?=$programa["curso"]?></h4>
                       <img class="img-thumbnail" src="/img/portfolio/<?=$programa["imagen"]?>"/>
</div>
<div class="col-lg-6"><?=$programa["descripcion"]?>
</div>
</div>
</div>
...
<ul class="list-group">
 <?
$sql2="SELECT * from capitulos where idcursosc=".$_GET["tipo"]." order by numero";
$rscapitulos2=mysqli_query($con,$sql2);
while($capitulo=mysqli_fetch_assoc($rscapitulos2)){


 ?>
 <li class="list-group-item"><span>Capitulo: <?=$capitulo["numero"]?></span>
  <h4><?=$capitulo["nombre"]?></h4>  
<ul class="list-group">
  <?
$sql="SELECT * from lecciones where idcapitulo=".$capitulo["id"]." order by numero";
$rslecciones=mysqli_query($con,$sql);
while($leccion=mysqli_fetch_assoc($rslecciones)){


  ?>
<li class="list-group-item" onclick="location.href='verleccion.php?idleccion=<?=$leccion['id']?>'"><span><?=$leccion["numero"]?>.<?=$leccion["titulo"]?></span>
