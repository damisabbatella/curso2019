...
<? include("includes/inc_nav.php") ?>
                ...
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="col-md-4">
                                    <button class="btn btn-md btn-success" onclick="location.href='nuevo.php'"><i class="fa fa-home fa-plus"></i>Nuevo</button>
                                    <button class="btn btn-md btn-warning" onclick="editarcurso()"><i class="fa fa-home fa-pencil"></i>Editar</button>
    ...
    <!-- /#wrapper -->
        ...
        <input type="hidden" value="curso|descripcion|texto|orden|imagen" id="columnas"/>
