...
//SI LA TABLA ES ALUMNOS Y LA CONTRASEÑA ESTA VACIA NO MODIFICO EL CAMPO CONTRASEÑA
if($tabla=="alumnos"){

  if($datos[4]==""){//no cambia la conrtraseña
...
//cambia la contraseña con md5
 $sql="UPDATE $tabla SET $col[0]='" . $datos[0] . "',$col[1]='" . $datos[1] . "',$col[2]='" . $datos[2] . "',$col[3]='" . $datos[3] . "',$col[4]='" . md5($datos[4]) . "' where id=" . $_POST['seleccionados'];
